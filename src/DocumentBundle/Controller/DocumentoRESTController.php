...
class DocumentoRESTController extends VoryxController
{
    ...
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        try {
            ...
            $entities = $em->getRepository('DocumentBundle:Documento')->findBy($filters, $order_by, $limit, $offset);
            if ($entities) {
                return $entities;
            }
     ...
     * @return Response
     */
    public function putAction(Request $request, Documento $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
    ...
    /**
     * Partial Update to a Documento entity.
     *
     * @View(serializerEnableMaxDepthChecks=true)
     *
     * @param Request $request
     ...
     * @return Response
     */
    public function deleteAction(Request $request, Documento $entity)
    {
        try {
            $em = $this->getDoctrine()->getManager();
            $em->remove($entity);
